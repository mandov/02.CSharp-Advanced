...
class SnackytheSnake
{
    static void Main()
    {
        ...
        while (directions.Length >= counter)
        {
            ...
            {
                case "d":
                    curRow++; if (curRow > den.GetLength(0) - 1)
                    {
                        Console.WriteLine("Snacky will be lost into the depths with length {0}", length); stop = true;
                        break;
                    }
                    break;
                case "u":
                ...
                case "l":
                    ...
                    break;
                case "r":
                    curCol++; if (curCol > den.GetLength(1) - 1)
                    {
                        curCol = 0;
                    }
                    break;
            ...
            {
                case '*': length++; den[curRow, curCol] = ' '; break;
                case '#': length--; Console.WriteLine("Snacky will hit a rock at [{0},{1}]", curRow, curCol); stop = true; break;
                case '.': break;
            }
